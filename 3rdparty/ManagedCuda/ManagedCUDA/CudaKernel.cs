...
namespace ManagedCuda
{
	...
	public class CudaKernel
	{
		...
		public CudaKernel(string kernelName, CUmodule module, CudaContext cuda)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuModuleGetFunction", res, _kernelName));
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuFuncGetAttribute", res, _kernelName));
			if (res != CUResult.Success) throw new CudaException(res);
		...
		public void SetConstantVariable<T>(string name, T value) where T : struct
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuModuleGetGlobal", res, _kernelName));
			if (res != CUResult.Success) throw new CudaException(res);
			...
			try
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuMemcpyHtoD", res, _kernelName));
			}
			finally
			{
				handle.Free();
		...
		public virtual float Run(params object[] parameters)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuCtxSynchronize", res, _kernelName));
			if (res != CUResult.Success) throw new CudaException(res);
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuLaunchKernel", res, _kernelName));
        ...
        public virtual void RunCooperative(CUstream stream, params object[] parameters)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuLaunchCooperativeKernel", res, _kernelName));
        ...
        public static void RunCooperativeKernelMultiDevie(CudaLaunchParams[] launchParameterList, CudaCooperativeLaunchMultiDeviceFlags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuLaunchCooperativeKernelMultiDevice", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
		#endregion
        ...
        public int MaxDynamicSharedSizeBytes
        {
            ...
            set
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, Kernel: {3}", DateTime.Now, "cuFuncSetAttribute", res, _kernelName));
                if (res != CUResult.Success) throw new CudaException(res);
            }
        }
        ...
        public void SetSharedMemConfig(CUsharedconfig config)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuFuncSetSharedMemConfig", res));
		...
		public void SetCacheConfig(CUFuncCache config)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuFuncSetCacheConfig", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		#endregion
		...
		public int GetOccupancyMaxActiveBlocksPerMultiprocessor(int blockSize, SizeT dynamicSMemSize)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuOccupancyMaxActiveBlocksPerMultiprocessor", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
			return numBlocks;
		}
		...
		public Occupancy GetOccupancyMaxPotentialBlockSize()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuOccupancyMaxPotentialBlockSize", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
			return occupancy;
		}
		...
		public int GetOccupancyMaxActiveBlocksPerMultiprocessor(int blockSize, SizeT dynamicSMemSize, CUoccupancy_flags flags)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
			return numBlocks;
		}
		...
		public Occupancy GetOccupancyMaxPotentialBlockSize(CUoccupancy_flags flags)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuOccupancyMaxPotentialBlockSizeWithFlags", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
			return occupancy;
		}
