	...
	public class CudaContext : IDisposable
	{
		...
		public CudaContext(int deviceId, CUCtxFlags flags, bool createNew)
		{
			...
			if (!createNew) //bind to existing cuda context
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetCurrent", res));
				if (res != CUResult.Success)
					throw new CudaException(res);
			...
			if (createNew)
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxCreate", res));
				if (res != CUResult.Success)
					throw new CudaException(res);
				_contextOwner = true;
			}
		...
		private CudaContext(CUCtxFlags flags, int deviceId)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuGLCtxCreate", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		...
		protected virtual void Dispose(bool fDisposing)
		{
			if (fDisposing && !disposed)
			{
				if (_contextOwner)
				{
					...
					Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxDestroy", res));
				}
				disposed = true;
			}
			if (!fDisposing && !disposed)
		...
		public Version GetAPIVersionOfCurrentContext()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetApiVersion", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		...
		public void Synchronize()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxSynchronize", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void PushContext()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxPushCurrent", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void PopContext()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxPopCurrent", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void SetCurrent()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxSetCurrent", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void SetSharedMemConfig(CUsharedconfig config)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxSetSharedMemConfig", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public CUsharedconfig GetSharedMemConfig()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetSharedMemConfig", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
			return config;
		}
		...
		public CUmodule LoadModule(string modulePath)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuModuleLoad", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		...
		public CUmodule LoadModulePTX(byte[] moduleImage, CudaJitOptionCollection options)
		{
			...
			if (options == null)
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuModuleLoadDataEx", res));
			}
			else
			{
		...
		public void UnloadModule(CUmodule aModule)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuModuleUnload", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void UnloadKernel(CudaKernel aKernel)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}, module name: {3}", DateTime.Now, "cuModuleUnload", res, aKernel.KernelName));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public CUdeviceptr AllocateMemory(SizeT aSizeInBytes)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemAlloc", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		...
		public void ClearMemory(CUdeviceptr aPtr, byte aValue, SizeT aSizeInBytes)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD8", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemory(CUdeviceptr aPtr, ushort aValue, SizeT aSizeInBytes)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD16", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemory(CUdeviceptr aPtr, uint aValue, SizeT aSizeInBytes)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD32", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemory(CUdeviceptr aPtr, byte aValue, SizeT aPitch, SizeT aWidth, SizeT aHeight)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD2D8", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemory(CUdeviceptr aPtr, ushort aValue, SizeT aPitch, SizeT aWidth, SizeT aHeight)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD2D16", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemory(CUdeviceptr aPtr, uint aValue, SizeT aPitch, SizeT aWidth, SizeT aHeight)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD2D32", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		#endregion
		...
		public void ClearMemoryAsync(CUdeviceptr aPtr, byte aValue, SizeT aSizeInBytes, CUstream stream)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD8Async", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemoryAsync(CUdeviceptr aPtr, ushort aValue, SizeT aSizeInBytes, CUstream stream)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD16Async", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemoryAsync(CUdeviceptr aPtr, uint aValue, SizeT aSizeInBytes, CUstream stream)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD32Async", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemoryAsync(CUdeviceptr aPtr, byte aValue, SizeT aPitch, SizeT aWidth, SizeT aHeight, CUstream stream)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD2D8Async", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemoryAsync(CUdeviceptr aPtr, ushort aValue, SizeT aPitch, SizeT aWidth, SizeT aHeight, CUstream stream)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD2D16Async", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public void ClearMemoryAsync(CUdeviceptr aPtr, uint aValue, SizeT aPitch, SizeT aWidth, SizeT aHeight, CUstream stream)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemsetD2D32Async", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		#endregion
		...
		public void FreeMemory(CUdeviceptr dBuffer)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemFree", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public SizeT GetTotalDeviceMemorySize()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemGetInfo", res));
		...
		public bool DeviceCanAccessPeer(CudaContext peerContext)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuDeviceCanAccessPeer", res));
			if (res != CUResult.Success) throw new CudaException(res);
		...
		public CUFuncCache GetCacheConfig()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetCacheConfig", res));
			if (res != CUResult.Success) throw new CudaException(res);
			return cache;
		}
		...
		public void SetCacheConfig(CUFuncCache cacheConfig)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxSetCacheConfig", res));
			if (res != CUResult.Success) throw new CudaException(res);
		}
		...
		public void CopyToHost<T>(T[] aDest, CUdeviceptr aSource) where T : struct
		{
			...
			try
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuMemcpyDtoH_v2", res));
			}
			finally
			{
				handle.Free();
		...
		public string GetDeviceName()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuDeviceGetName", res));
			if (res != CUResult.Success) throw new CudaException(res);
		...
		public Version GetDeviceComputeCapability()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuDeviceGetAttribute", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		...
		public void GetStreamPriorityRange(ref int leastPriority, ref int greatestPriority)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetStreamPriorityRange", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public SizeT GetLimit(CULimit limit)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetLimit", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
			return ret;
		}
		...
		public void SetLimit(CULimit limit, SizeT value)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxSetLimit", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		#endregion
		...
		public static CUdevice[] GetOpenGLDevices(CUGLDeviceList deviceList)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuGLGetDevices", res));
		...
		public static Version GetDriverVersion()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuDriverGetVersion", res));
			if (res == CUResult.ErrorNotInitialized)
			{
				res = DriverAPINativeMethods.cuInit(CUInitializationFlags.None);
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuInit", res));
		...
		public static void EnablePeerAccess(CudaContext peerContext)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxEnablePeerAccess", res));
			if (res != CUResult.Success) throw new CudaException(res);
		}
		...
		protected static CudaDeviceProperties GetDeviceInfo(CUdevice device)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuDeviceTotalMem", res));
			if (res != CUResult.Success) throw new CudaException(res);
		...
		public static void ProfilerInitialize(string configFile, string outputFile, CUoutputMode outputMode)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuProfilerInitialize", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public static void ProfilerStart()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuProfilerStart", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		...
		public static void ProfilerStop()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuProfilerStop", res));
			if (res != CUResult.Success)
				throw new CudaException(res);
		}
		#endregion
		...
		public CUCtxFlags Flags
		{
			get 
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuCtxGetFlags", res));
				if (res != CUResult.Success) throw new CudaException(res);
				return flags; 
			}
		}
