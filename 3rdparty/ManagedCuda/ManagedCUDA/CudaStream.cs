...
namespace ManagedCuda
{
    ...
    public class CudaStream : IDisposable
    {
        ...
        public CudaStream(CUStreamFlags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamCreate", res));
        ...
        public CudaStream(int priority, CUStreamFlags flags)
        {
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamCreateWithPriority", res));
			if (res != CUResult.Success) throw new CudaException(res);
			_isOwner = true;
        }
        ...
        public bool Query()
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamQuery", res));
		...
		public void AddCallback(CUstreamCallback callback, IntPtr userData, CUStreamAddCallbackFlags flags)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamAddCallback", res));
			if (res != CUResult.Success) throw new CudaException(res);
		...
		public int GetPriority()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamGetPriority", res));
			if (res != CUResult.Success) throw new CudaException(res);
			return priority;
		}
		...
		public CUStreamFlags cuStreamGetFlags()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamGetFlags", res));
			if (res != CUResult.Success) throw new CudaException(res);
			return flags;
		}
        ...
        public void WaitValue(CUdeviceptr addr, uint value, CUstreamWaitValue_flags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamWaitValue32", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void WaitValue(CUdeviceptr addr, ulong value, CUstreamWaitValue_flags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamWaitValue64", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void WriteValue(CUdeviceptr addr, uint value, CUstreamWriteValue_flags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamWriteValue32", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void WriteValue(CUdeviceptr addr, ulong value, CUstreamWriteValue_flags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuStreamWriteValue64", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
        #endregion
    }
