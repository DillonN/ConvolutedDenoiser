...
namespace ManagedCuda
{
    ...
    public class CudaEvent : IDisposable
    {
        ...
        public CudaEvent(CUEventFlags flags)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuEventCreate", res));
        ...
        protected virtual void Dispose(bool fDisposing)
        {
            if (fDisposing && !disposed)
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuEventDestroy", res));
                disposed = true;
            }
            if (!fDisposing && !disposed)
        ...
        public void Record()
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuEventRecord", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void Synchronize()
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuEventSynchronize", res));
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public bool Query()
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuEventQuery", res));
        ...
        public static float ElapsedTime(CudaEvent eventStart, CudaEvent eventEnd)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuEventElapsedTime", res));
            if (res != CUResult.Success) throw new CudaException(res);
            return time;
        }
