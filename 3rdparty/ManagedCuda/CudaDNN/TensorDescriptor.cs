...
namespace ManagedCuda.CudaDNN
{
    ...
    public class TensorDescriptor : IDisposable
    {
        ...
        public TensorDescriptor()
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnCreateTensorDescriptor", res));
        ...
        protected virtual void Dispose(bool fDisposing)
        {
            if (fDisposing && !disposed)
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnDestroyTensorDescriptor", res));
                disposed = true;
            }
            if (!fDisposing && !disposed)
                                        ...
                                        )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetTensor4dDescriptor", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                            ...
                                            )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetTensor4dDescriptorEx", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                        ...
                                        )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetTensor4dDescriptor", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                            ...
                                            )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetTensorNdDescriptor", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                ...
                                int[] dimA)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetTensorNdDescriptorEx", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
        ...
        public SizeT GetTensorSizeInBytes()
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetTensorSizeInBytes", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
            return retVal;
        }
                                            ...
                                            )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetTensorNdDescriptor", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
    }
}
