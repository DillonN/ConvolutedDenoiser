...
namespace ManagedCuda.CudaDNN
{
    ...
    public class RNNDescriptor : IDisposable
    {
        ...
        public RNNDescriptor(CudaDNNContext context)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnCreateRNNDescriptor", res));
        ...
        protected virtual void Dispose(bool fDisposing)
        {
            if (fDisposing && !disposed)
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnDestroyRNNDescriptor", res));
                disposed = true;
            }
            if (!fDisposing && !disposed)
        ...
        public void GetRNNWorkspaceSize(int seqLength, TensorDescriptor[] xDesc, ref SizeT sizeInBytes)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetRNNWorkspaceSize", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                                    ...
                                                    )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetRNNTrainingReserveSize", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                                 ...
                                                 cudnnDataType dataType   )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetRNNParamsSize", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                             ...
                             )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetRNNLinLayerMatrixParams", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                             ...
                             )
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetRNNLinLayerBiasParams", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                                    ...
                                                    SizeT workSpaceSizeInBytes)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnRNNForwardInference", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                                   ...
                                                   SizeT reserveSpaceSizeInBytes)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnRNNForwardTraining", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                                ...
                                                SizeT reserveSpaceSizeInBytes)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnRNNBackwardData", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
                                                   ...
                                                   SizeT reserveSpaceSizeInBytes)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnRNNBackwardWeights", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
        ...
        public void SetPersistentRNNPlan(PersistentRNNPlan plan)
        {
            ...
            Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetPersistentRNNPlan", res));
            if (res != cudnnStatus.Success) throw new CudaDNNException(res);
        }
        ...
        public cudnnMathType MathType
        {
            ...
            //    Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetConvolutionMathType", res));
            //    if (res != cudnnStatus.Success) throw new CudaDNNException(res);
            //    return mathType;
            //}
            set
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetRNNMatrixMathType", res));
                if (res != cudnnStatus.Success) throw new CudaDNNException(res);
            }
        }
    }
