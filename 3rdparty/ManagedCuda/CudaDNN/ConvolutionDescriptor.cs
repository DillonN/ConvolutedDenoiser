...
namespace ManagedCuda.CudaDNN
{
	...
	public class ConvolutionDescriptor : IDisposable
	{
		...
		public ConvolutionDescriptor()
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnCreateConvolutionDescriptor", res));
		...
		protected virtual void Dispose(bool fDisposing)
		{
			if (fDisposing && !disposed)
			{
				...
				Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnDestroyConvolutionDescriptor", res));
				disposed = true;
			}
			if (!fDisposing && !disposed)
                                            ...
                                            )
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetConvolution2dDescriptor", res));
			if (res != cudnnStatus.Success) throw new CudaDNNException(res);
		}
                                            ...
                                            )
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetConvolutionNdDescriptor", res));
			if (res != cudnnStatus.Success) throw new CudaDNNException(res);
		}
        /// <summary>
                                            ...
                                            )
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetConvolutionNdDescriptor", res));
			if (res != cudnnStatus.Success) throw new CudaDNNException(res);
		}
												...
												)
		{
			...
			Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetConvolutionNdForwardOutputDim", res));
			if (res != cudnnStatus.Success) throw new CudaDNNException(res);
		}
        ...
        public cudnnMathType MathType
        {
            ...
            set
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetConvolutionMathType", res));
                if (res != cudnnStatus.Success) throw new CudaDNNException(res);
            }
        }
        ...
        public int GroupCount
        {
            get
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnGetConvolutionGroupCount", res));
                if (res != cudnnStatus.Success) throw new CudaDNNException(res);
                return groupCount;
            }
            set
            {
                ...
                Debug.Write("");//Line(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cudnnSetConvolutionGroupCount", res));
                if (res != cudnnStatus.Success) throw new CudaDNNException(res);
            }
        }
    }
